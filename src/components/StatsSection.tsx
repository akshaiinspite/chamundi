...
const GuestsSVG = () => (
  <svg className="w-12 h-12 mx-auto mb-4" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Pulsing hearts/ripples of satisfied users */}
...
const stats = [
  { value: 3000, suffix: '+', label: 'Years of Ayurvedic Science', svg: ScienceSVG },
  { value: 1500, suffix: '+', label: 'Satisfied Rejuvenated Guests', svg: GuestsSVG },
  { value: 100, suffix: '%', label: 'Certified Ayurvedic Doctors', svg: DoctorsSVG },
  { value: 28, suffix: ' Days', label: 'Full Panchakarma Program', svg: ProgramSVG },
];
...
export default function StatsSection() {
  ...
  return (
    <section className="bg-[#1E1810] py-20 sm:py-28 relative overflow-hidden text-white">
      ...
      >
        <span className="section-label">Retreat Metrics</span>
        ...
        {/* Feature Chips with staggered hover transitions */}
